class ServiceGrantScholar extends Scholar implements renewBenefit, PrintableNotice, ServiceHourCheckable {
    private final double GWA_Req = 2.50;
    private final int Min_srvcHour = 30 ;
    private final int Max_absence = 5;

    public ServiceGrantScholar(String name, String scholarID, double gwa, double serviceHoursTotal, int attendanceIssues) {
        super(name, scholarID, gwa, serviceHoursTotal, attendanceIssues);
    }

    @Override
    public String getScholarCategoryName() {
        this.scholarType = "Service Grant Scholarship";
        return this.scholarType;
    }   

    @Override
    public boolean checkHoursCompleted(int serviceHoursTotal) {
        return (serviceHoursTotal >= Min_srvcHour);
    }
    ...
    public void evalStatus() {
        ...
        System.out.println("Class Attended              : " + attendanceIssues);
        System.out.println("Service Hours Completed     : " + serviceHoursTotal);
